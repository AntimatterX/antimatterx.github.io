/*!
 * CmdExt JavaScript Library v2.0.4
 ...
 * CmdExt
 * 
 * Last Update: 2021-03-28T11:49:16.439Z
 */
(function _main(_root, undefined) {
    ...
    var _lib = {
        ...
        val: (function () { // エクスポートされるライブラリの値
             ...
             */
            CmdExt.prototype.noConflict = CmdExt.noConflict = function () {
                _ctx.fn.noConflict();
                return _lib.val;
            };
            /**
            ...
            CmdExt.prototype.version = CmdExt.version = '2.0.4';
            CmdExt.prototype.conflict = CmdExt.conflict = _ctx.conflict;
            ...
            CmdExt.prototype.exec = function (str) {
                ...
                } else command.callback.apply(null, [context].concat(parsed.args));
                return this;
            };
            /**
             * ハンドラーを登録します。
