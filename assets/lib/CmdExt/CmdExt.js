/*!
 * CmdExt JavaScript Library v2.0.0
        ...
        val: (function () { // エクスポートされるライブラリの値
            ...
            CmdExt.prototype.exec = function (str) {
                ...
                if (command === undefined || !command.enabled) {
                    var err = command === undefined ? new CmdExt.errors.CommandNotFound("Command '" + parsed.pathname + "' is not found") :
                        new CmdExt.errors.DisabledCommand("Command '" + parsed.pathname + "' is disabled");
                    if (this._handlers.commanderror.length < 1 &&
                        ...
                        context.error = err;
                        this._trigger(command === undefined ? 'commandnotfound' : 'disabledcommand', context);
                    }
                }
                return this;
            };
